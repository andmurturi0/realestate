...
const steps = [
    {
        icon: Search,
        title: 'Kërkimi',
        description: 'Agjentët tanë kërkojnë prona që përputhen me kriteret tuaja.',
    },
    {
        icon: ClipboardCheck,
        title: 'Përputhjet',
        description: 'Sapo gjendet një pronë përputhëse, ju njoftojmë menjëherë.',
    },
    {
        icon: MessageCircle,
        title: 'Ju kontaktojmë',
        description: 'Një agjent ju kontakton për të organizuar një vizitë.',
    },
];
</script>

<template>
    <Head title="Krijoni Kërkesën Tuaj" />

    <PublicLayout>
        <div class="mx-auto w-full max-w-2xl px-4 py-10">
            <div class="mb-6 text-center">
                <h1 class="text-2xl font-semibold">Krijoni Kërkesën Tuaj</h1>
                <p class="mt-2 text-muted-foreground">Na tregoni çfarë kërkoni dhe do t'ju njoftojmë sapo gjejmë një pronë përputhëse.</p>
            </div>

            <RequestForm :municipalities="municipalities" />

            <div class="mt-8 rounded-xl border bg-card p-6">
                <h2 class="mb-4 font-semibold">Çfarë ndodh pas dërgimit të kërkesës?</h2>
